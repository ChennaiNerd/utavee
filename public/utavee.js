;(function() {
    ...
    var utavee = {
        ...
        setIdentity : function (obj) {
            ...
            iframe.setAttribute("style", "position:fixed; bottom:0; right: 50px; width: 512px; height: 600px;");
    ...
    window.onload = function(){
        ...
        // iframe.frameBorder=0;
        // iframe.setAttribute("src", link);
        // iframe.setAttribute("style", "position:fixed; bottom:0; right: 50; width: 512px; height: 600px;");
        // document.getElementsByTagName("body")[0].appendChild(iframe);
    }
